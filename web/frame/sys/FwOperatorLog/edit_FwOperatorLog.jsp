...
<head>
	<base href="<%=basePath%>" />
	<title><%=FwOperatorLog.TABLE_ALIAS%>编辑</title>
...
<form action="${ctx}/frame/sys/FwOperatorLog/update.do" method="post" validator="true">
	<div id="infoPanel">
			...
			<div class="form_panel">
				<table class="form_table" cellpadding="0" cellspacing="1"
					...
					<tbody attr="tbody_1">
						<%@ include file="form_include_FwOperatorLog.jsp" %>
					</tbody>
				</table>
			</div>
</form>
