...
<head>
	...
	<script>
		var groupList = [{value:'1',labelCn:'1'},{value:'2',labelCn:'2'}];
		...
		<div class="grid-data-panel">
			<table cellspacing="0" cellpadding="0">
				...
				<tbody>
					<tr class="odd">
						<td>1行1列</td>
						<td editable="true" editdata="groupList">
							<input edittype="value" type="hidden" name="test" value="1行2列"/>
							<input type="text" edittype="labelCn" value=""/>
						</td>
						<td editable="true" editdata="getGroupList()">
							<input type="text" name="test" value="1行3列"/>
							<input type="text" edittype="labelCn" value=""/>
						</td>
						<td>1行4列</td>
						<td>1行5列</td>
