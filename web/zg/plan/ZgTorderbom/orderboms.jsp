...
<head>
	...
	<style>
    	...
    	#matnrChildListDiv {width:84.5%;height:100%;float:left;overflow:hidden;margin:0 0 0 1px}
		#matnrListDiv ul{
	...
	<script type="text/javascript">
		$(function() {
			try{
				...
				document.getElementById("matnrListDiv").style.width="130px";
				document.getElementById("matnrChildListDiv").style.width = document.body.offsetWidth - 134 + 'px';
			}catch(e){}
		});
		...
		function submitOrder() {
			if(window.confirm("温馨提示：\n    请确认对订单的调整是否均已保存？\n\n确定：提交订单\n取消：继续调整订单"))
				window.location.href="${ctx}/zg/plan/ZgTorder/submitOrder.do?orderId=${orderId}";
		}
	</script>
</head>
<body>
			...
			<tr>
				<td class="formToolbar">
					<div class="button" style="text-align: left;">
						...
						<a href="javascript:"><span onclick="submitOrder()"><img src="<%=iconPath%>/true.gif" />提交</span></a>
					</div>
				</td>
			</tr>
		</thead>
