...
<%@ include file="/commons/taglibs.jsp" %>
	...
	<input type="hidden"  name="ec_s_t0_OPERATE_TYPE" value="<%=map.get("ec_s_t0_OPERATE_TYPE")==null?"":map.get("ec_s_t0_OPERATE_TYPE")%>"/>
	<input type="hidden"  name="ec_a_OPERATE_TYPE" value="operateType" />
	<input type="hidden"  name="s_operateType"  value="${pageRequest.filters.operateType}" />
	<input type="hidden"  name="ec_s_t0_PSBH" value="<%=map.get("ec_s_t0_PSBH")==null?"":map.get("ec_s_t0_PSBH")%>"/>
	<input type="hidden"  name="ec_a_PSBH" value="psbh" />
	<input type="hidden"  name="s_psbh"  value="${pageRequest.filters.psbh}" />
