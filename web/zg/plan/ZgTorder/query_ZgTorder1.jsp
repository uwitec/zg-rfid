...
<body>
<div id="_queryPanel">
	<form action="${ctx}/zg/plan/ZgTorder/listForSelect.do" method="post" target="listFrame">
		...
		<table id="query_table" class="query_panel" cellpadding="0" cellspacing="0">
			<thead class="querybar">
				<tr>
					...
					<td><input type="text" name="s_labelCn" maxlength="40"/>
					<input type="hidden" name="s_flag" maxlength="40" value="${flag }"/>
					<input type="hidden" name="s_sourceOrderId" maxlength="40" value="${sourceOrderId }"/></td>
			...
			<tfoot class="querybar">
				<tr>
					<td colspan="7" align="right" class="toolbar">
						<div class="toolbar">
							<a id="queryBtn" href="javascript:if(batchValidation('listFrame','${ctx}/zg/plan/ZgTorder/listForSelect.do',document.forms[0]))document.forms[0].submit();"><span><img src="<%=iconPath%>/ico_search.gif" />查询</span></a>
