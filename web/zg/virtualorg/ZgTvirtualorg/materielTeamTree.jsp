    ...
    function onItemClick(){
        ...
        return checkedIds.join(',');
			...
			button.on('click',function(){
				var allMaterielId = '';//所有打钩的节点，除了仓库节点
				selNodes = navTreePanel.getChecked();//这里是拿到全部打钩的
				for(var i=0;i<selNodes.length;i++){
					if(selNodes[i].parentNode.text!="导航树"){//证明是一级节点
						var id = selNodes[i].attributes.cuid;//拿到id
						allMaterielId+=id+",";
					}
				}
				var obj=new Object();
