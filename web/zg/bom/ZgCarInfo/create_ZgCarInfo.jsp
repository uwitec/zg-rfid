...
<head>
	<base href="<%=basePath%>" />
	<title><%=ZgCarInfo.TABLE_ALIAS%>新增</title>
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#<%=ZgCarInfo.TABLE_ALIAS%>CreateDiv").accordion();
		...
		function submitCheck(){
			if($("form[validator]").valid())
			{
				...
				ZgCarInfoDwrAction.CheckTheOne(code,function(data){
					if(data == true){
...
<body>
<form action="${ctx}/zg/bom/ZgCarInfo/save.do" method="post"
			validator="true">
			<div id="infoPanel">
