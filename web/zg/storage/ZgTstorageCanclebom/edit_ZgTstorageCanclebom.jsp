...
<head>
	<base href="<%=basePath%>" />
	<title><%=ZgTstorageCanclebom.TABLE_ALIAS%>新增</title>
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#<%=ZgTstorageCanclebom.TABLE_ALIAS%>CreateDiv").accordion();
...
<form action="${ctx}/zg/storage/ZgTstorageCanclebom/save.do" method="post" validator="true">
	...
	<div id="<%=ZgTstorageCanclebom.TABLE_ALIAS%>EditDiv">
		<div>
		<table class="formTable" >
				<%@ include file="form_include_ZgTstorageCanclebom.jsp" %>
		</table>
		</div>
	</div>
