...
<%@ include file="/commons/taglibs.jsp" %>
	...
	<input type="hidden"  name="ec_s_t0_ZG_T_STORAGE_ID" value="<%=map.get("ec_s_t0_ZG_T_STORAGE_ID")==null?"":map.get("ec_s_t0_ZG_T_STORAGE_ID")%>"/>
	<input type="hidden"  name="ec_a_ZG_T_STORAGE_ID" value="zgTstorageId" />
	<input type="hidden"  name="s_zgTstorageId"  value="${pageRequest.filters.zgTstorageId}" />
