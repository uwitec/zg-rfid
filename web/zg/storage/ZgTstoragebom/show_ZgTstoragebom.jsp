...
<head>
	<base href="<%=basePath%>" />
	<title><%=ZgTstoragebom.TABLE_ALIAS%>信息</title>
	<%@ include file="/commons/meta.jsp" %>
	<%@ include file="/commons/jquery.jsp" %>
	<script type="text/javascript">
		$(function() {
			$("button ,input:button,input:submit").button();
			$("#<%=ZgTstoragebom.TABLE_ALIAS%>ShowDiv").accordion({
				collapsible: true
			});
			if(initLayout) {
...
<body>
	...
	<form action="${ctx}/zg/storage/ZgTstoragebom/list.do" method="get" theme="simple">
		<s:hidden name="cuid" id="cuid" value="%{model.cuid}"/>
		<div id="<%=ZgTstoragebom.TABLE_ALIAS%>ShowDiv">
			<h3><a href="#"><%=ZgTstoragebom.TABLE_ALIAS%>信息</a></h3>
			<div>
				<table class="formTable">
					...
					<tr>	
						...
						<td><s:property value="%{model.zgTstorageId}" /></td>
					</tr>
					<tr>	
