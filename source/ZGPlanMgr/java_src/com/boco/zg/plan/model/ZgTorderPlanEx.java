...
public class ZgTorderPlanEx extends BaseEntity{
	...
	public Long getNotSetBomNum() {
		return notSetBomNum;
	}

	public void setNotSetBomNum(Long notSetBomNum) {
		this.notSetBomNum = notSetBomNum;
	}
