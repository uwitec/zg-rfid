...
<head>
	<base href="<%=basePath%>" />
	<title><%=FwSystemNotice.TABLE_ALIAS%>信息</title>
...
<body>
	...
	<form action="${ctx}/frame/sys/FwSystemNotice/list.do" method="get" theme="simple">
			<s:hidden name="cuid" id="cuid" value="%{model.cuid}"/>
		
		<div class="form_panel">
			<table class="form_table" cellpadding="1" cellspacing="1" style="margin-top:3px;">
					<tr>	
						<td class="label"><%=FwSystemNotice.ALIAS_TITLE%></td>	
						<td><s:property value="%{model.title}" /></td>
					</tr>
					<tr>	
						<td class="label"><%=FwSystemNotice.ALIAS_CONTENT%></td>	
