...
public class TmdNodetype extends BaseEntity {
	
	//alias
	public static final String TABLE_ALIAS = "TmdNodetype";
	public static final String ALIAS_CUID = "cuid";
	public static final String ALIAS_BM_CLASSID = "bmClassid";
	public static final String ALIAS_LABEL_CN = "labelCn";
	public static final String ALIAS_ISVNODETYPE = "isvnodetype";
	...
	private java.lang.String isvnodetype;
	...
	public java.lang.String getIsvnodetype() {
		return this.isvnodetype;
	}
	
	public void setIsvnodetype(java.lang.String value) {
		this.isvnodetype = value;
	}
	...
	public String toString() {
		return new ToStringBuilder(this)
			...
			.append("Isvnodetype",getIsvnodetype())
	...
	public int hashCode() {
		return new HashCodeBuilder()
			...
			.append(getBmClassid())
			.append(getLabelCn())
			.append(getIsvnodetype())
			.append(getRemark())
			.toHashCode();
	}
	
	public boolean equals(Object obj) {
		if(obj instanceof TmdNodetype == false) return false;
		if(this == obj) return true;
		TmdNodetype other = (TmdNodetype)obj;
		return new EqualsBuilder()
			.append(getCuid(),other.getCuid())
			.append(getBmClassid(),other.getBmClassid())
			.append(getLabelCn(),other.getLabelCn())
			.append(getIsvnodetype(),other.getIsvnodetype())
