...
public class TmdSlottype extends BaseEntity {
	
	//alias
	public static final String TABLE_ALIAS = "TmdSlottype";
	...
	public boolean equals(Object obj) {
		if(obj instanceof TmdSlottype == false) return false;
		if(this == obj) return true;
		TmdSlottype other = (TmdSlottype)obj;
