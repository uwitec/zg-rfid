...
<head>
	...
	<script type="text/javascript">
		...
		function doQuery() {
			...
			if(batchValidation('listFrame','${ctx}/zg/plan/ZgTorder/list5.do',document.forms[0])) {
		...
		*/
		...
		function exportData(){
			...
			document.forms[0].submit();
			document.forms[0].action = "${ctx}/zg/plan/ZgTorder/list5.do";
		}
...
<body>
<div id="_queryPanel">
	<form action="${ctx}/zg/plan/ZgTorder/list5.do" method="post" target="listFrame">
		...
		<table id="query_table" class="query_panel" cellpadding="0" cellspacing="0">
			<thead class="querybar">
				<tr>
					...
					<input type="hidden" name="s_orderState" value="8" />
					<!-- 
			...
			<tfoot class="querybar">
				<tr>
					<td colspan="7" align="right" class="toolbar">
						<div class="toolbar">
							<a id="queryBtn" href="javascript:if(batchValidation('listFrame','${ctx}/zg/plan/ZgTorder/list5.do',document.forms[0]))document.forms[0].submit();"><span><img src="<%=iconPath%>/ico_search.gif" />查询</span></a>
