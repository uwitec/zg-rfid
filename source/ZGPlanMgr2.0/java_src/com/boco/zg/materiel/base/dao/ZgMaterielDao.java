...
public class ZgMaterielDao extends BaseIbatisDao<ZgMateriel,java.lang.String>{
	 ...
	 * @return
	 */
	public boolean updateMaterielLevel(Map paramsMap) {
		return getSqlMapClientTemplate().update("ZgMateriel.updateMaterielLevel",paramsMap)>0;
	}
	 ...
	 * @return
	 */
	public String getMaterielLevelByTaskBomId(Map paramsMap) {
		Object resultObject=getSqlMapClientTemplate().queryForObject("ZgMateriel.getMaterielLevelByTaskBomId", paramsMap);
