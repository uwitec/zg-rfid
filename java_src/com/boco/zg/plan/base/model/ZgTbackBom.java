...
public class ZgTbackBom extends BaseEntity {
	
	//alias
	public static final String TABLE_ALIAS = "ZG_T_BACK_BOM";
	public static final String BM_CLASS_ID = "ZG_T_BACK_BOM";
	...
	public static final String ALIAS_LGORT_D = "仓库";
	...
	private java.lang.String lgortD;
	...
	public java.lang.String getLgortD() {
		return this.lgortD;
	}
	
	public void setLgortD(java.lang.String value) {
		this.lgortD = value;
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof ZgTbackBom == false) return false;
		if(this == obj) return true;
		ZgTbackBom other = (ZgTbackBom)obj;
		return new EqualsBuilder()
			...
			.append(getLgortD(),other.getLgortD())
