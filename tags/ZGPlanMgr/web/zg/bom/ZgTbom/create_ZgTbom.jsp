...
<head>
	<base href="<%=basePath%>" />
	<title><%=ZgTbom.TABLE_ALIAS%>新增</title>
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#<%=ZgTbom.TABLE_ALIAS%>CreateDiv").accordion();
...
<form action="${ctx}/zg/bom/ZgTbom/save.do" method="post">
	<div id="<%=ZgTbom.TABLE_ALIAS%>CreateDiv">
		<h3><a href="#"><%=ZgTbom.TABLE_ALIAS%>新增</a></h3>
		<div>
