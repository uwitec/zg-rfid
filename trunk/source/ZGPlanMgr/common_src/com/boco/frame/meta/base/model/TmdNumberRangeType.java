...
public class TmdNumberRangeType extends BaseEntity {
	
	//alias
	public static final String TABLE_ALIAS = "码号模型表";
	...
	public boolean equals(Object obj) {
		if(obj instanceof TmdNumberRangeType == false) return false;
		if(this == obj) return true;
		TmdNumberRangeType other = (TmdNumberRangeType)obj;
