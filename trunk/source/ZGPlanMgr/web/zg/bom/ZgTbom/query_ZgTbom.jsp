...
<form action="${ctx}/zg/bom/ZgTbom/list.do" method="post" target="listFrame">
<table class="formTable">
		<tr class="toolbar">
			<td width="50px" style="padding-left:10px">
				<input type="submit" value="查询" class="commonButton queryButton" 
					onclick="batchValidation('listFrame','${ctx}/zg/bom/ZgTbom/list.do',document.forms[0])" />
			</td>
			<td>
			...
			<input type="hidden" value="${lgort }" name="s_lgort" />
				...
				BOM组件：
				<input type="text"  name="s_cuid" maxlength="40"/>
				物料描述：
...
<iframe src="${ctx}/zg/bom/ZgTbom/list.do" name="listFrame" frameborder="0" width="100%" height="100%" align="top" scrolling="no"/>
</body>
</html>