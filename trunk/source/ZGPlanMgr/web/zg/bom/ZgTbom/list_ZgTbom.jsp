...
<form id="ec" action="<c:url value="/zg/bom/ZgTbom/list.do"/>" method="get" style="display: inline;">
<% 
			...
			<div class="eXtremeTable" >
				<table id="ec_table"  border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="100%">
					<thead>
						...
						<tr>
							<td class="tableHeader"  onclick="queryColumn(this,'CUID')"  title="排序 maktx" ><%=ZgTbom.ALIAS_CUID %><%=map.get("ec_image_MAKTX")==null?"":map.get("ec_image_MAKTX")%></td>
						
							<td class="tableHeader"  onclick="queryColumn(this,'MAKTX')"  title="排序 maktx" ><%=ZgTbom.ALIAS_MAKTX %><%=map.get("ec_image_MAKTX")==null?"":map.get("ec_image_MAKTX")%></td>
							<td class="tableHeader"  onclick="queryColumn(this,'MATNR')"  title="排序 matnr" ><%=ZgTbom.ALIAS_MATNR %><%=map.get("ec_image_MATNR")==null?"":map.get("ec_image_MATNR")%></td>
							<td class="tableHeader"  onclick="queryColumn(this,'MSEHL')"  title="排序 msehl" ><%=ZgTbom.ALIAS_MSEHL %><%=map.get("ec_image_MSEHL")==null?"":map.get("ec_image_MSEHL")%></td>
							<td class="tableHeader"  onclick="queryColumn(this,'MATKL')"  title="排序 matkl" ><%=ZgTbom.ALIAS_MATKL %><%=map.get("ec_image_MATKL")==null?"":map.get("ec_image_MATKL")%></td>
							<td class="tableHeader"  onclick="queryColumn(this,'ZBZ')"  title="排序 zbz" ><%=ZgTbom.ALIAS_ZBZ%><%=map.get("ec_image_ZBZ")==null?"":map.get("ec_image_ZBZ")%></td>
							<td class="tableHeader"  onclick="queryColumn(this,'ZRZQD')"  title="排序 zrzqd" ><%=ZgTbom.ALIAS_ZRZQD %><%=map.get("ec_image_ZRZQD")==null?"":map.get("ec_image_ZRZQD")%></td>
							<td class="tableHeader"  onclick="queryColumn(this,'LGORT')"  title="排序 lgort" ><%=ZgTbom.ALIAS_LGORT %><%=map.get("ec_image_LGORT")==null?"":map.get("ec_image_LGORT")%></td>
