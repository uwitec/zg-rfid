...
<iframe id="orderDetailFrame" src="<c:url value="/zg/plan/ZgTcarplan/show.do?id=${carPlanId}&type=storage"/>" autolayout="true" scrolling="no" width="100%" frameborder="0"></iframe>
<form id="bomListForm" action="${ctx}/zg/plan/ZgTcarbom/findBomList2.do?view=${view}" method="post" target="bomListFrame">
