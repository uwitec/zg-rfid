...
<head>
	...
	<script type="text/javascript">
		...
		function doQuery() {
			...
			if(batchValidation('listFrame','${ctx}/zg/plan/ZgTBomManager/listForBack.do',document.forms[0])) {
				document.forms[0].submit();
			}
		}
...
<body>
<div id="_queryPanel">
	<form action="${ctx}/zg/plan/ZgTBomManager/listForBack.do" method="post" target="listFrame">
