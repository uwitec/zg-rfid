...
<%@ include file="/commons/taglibs.jsp" %>
	...
	<input type="hidden"  name="s_date_start"  value="${pageRequest.filters.date_start}" />
	
	
	<input type="hidden"  name="s_date_end"  value="${pageRequest.filters.date_end}" />
	...
	<input type="hidden"  name="s_suppliers"  value="${pageRequest.filters.suppliers}" />
