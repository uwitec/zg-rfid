...
public class ZgTorderPlanbomDao extends BaseIbatisDao<ZgTorderPlanbom,java.lang.String>{
	 ...
	 * @return
	 */
	public List<ZgTorderPlanbom> getAutoWaitBackBomListNotAuditByPbId(Map paramsMap) {
		return getSqlMapClientTemplate().queryForList("ZgTorderPlanbom.getAutoWaitBackBomListNotAuditByPbId",paramsMap);
	}
