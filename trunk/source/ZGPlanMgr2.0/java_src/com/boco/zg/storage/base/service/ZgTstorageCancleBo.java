...
@Component
public class ZgTstorageCancleBo extends BaseManager<ZgTstorageCancle,java.lang.String>{
	...
	public EntityDao getEntityDao() {
		return this.zgTstorageCancleDao;
	}
	public Page findByPageRequest(PageRequest pr) {
		return zgTstorageCancleDao.findByPageRequest(pr);
	}
	
	public void removeById(java.lang.String id) {
		zgTstorageCancleDao.deleteById(id);
	}
	
	public List<ZgTstorageCancle> findByRequest(PageRequest pageRequest) {
		return zgTstorageCancleDao.findByRequest(pageRequest);
	}
}
