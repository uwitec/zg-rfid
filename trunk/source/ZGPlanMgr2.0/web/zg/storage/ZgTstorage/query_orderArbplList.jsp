...
<div id="_queryPanel">
<form action="${ctx}/zg/storage/ZgTstorage/findOrderArbplList.do" method="post" target="listFrame">
					...
					<td colspan="7" align="right" class="toolbar">
						<div class="toolbar">
							<a href="javascript:"><span
									onclick="if(batchValidation('listFrame','${ctx}/zg/storage/ZgTstorage/findOrderArbplList.do',document.forms[0]));document.forms[0].submit();"><img
