				...
				<div class="datalist">
					...
					<div class="toolbar">
						<c:if test="${fn:indexOf(planType,'BACK')>=0}">
							<a href="javascript:batchDelete('${ctx}/zg/plan/ZgTBomManager/manulFinishBom.do','items',document.forms[0])"><span><img
										src="<%=iconPath%>/ico_009a.gif" />手工结单</span>
										</a>
						</c:if>
								...
								<c:forEach items="${bol}" var="obj" varStatus="n">  
									...
									<c:if test="${!obj.isDel}">
										...
										<td width="3%" align="center">
											<input type="checkbox" name="items" value="pbId=${obj.PBID}&" />
										</td>
										</c:if>
